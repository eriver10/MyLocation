...
//Testing: something wrong on this file. Replaced with source code and now its working!!
...
import CoreLocation
//error suggested add this import:
import CoreData
import UIKit
    ...
    @IBAction func done() {
     ...
     @IBAction func categoryPickerDidPickCategory(_ segue: UIStoryboardSegue) {
        ...
        override func viewDidLoad() {
            ...
            /*
             //Error here: Value 'location' was definedValue 'location' was defined but never used; consider replacing with boolean test
        ...
        //deinit\\
        //placing a print in this deinit to show, "that the view controller really does get destroyed when you close the Tag/Edit Location screen."
        deinit {
...
func show(image: UIImage) {
  ...
  tableView.reloadData()
            ...
            /*
             The book states, "the [weak self] bit is the capture list for the closure. It tells the closure that the variable self will still be captured, but as a weak reference. As a result, the closure no longer keeps the view controller alive."
             */
...
//NOTE: This extension allows for the grouping of, "photo-picking related functionality together." says the book.
extension LocationDetailsViewController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
